...
#define vec_floor(a) /* TODO vroundps equivalent */
#define vec_cmp_lt(a, b) (void) /* TODO: cmpps equivalent */
#define vec_cmp_result(a) (void) /* TODO: vmovmskps equivalent */
...
#define vec_dbl_tofloat_lo(a) _mm256_castps128_ps256(_mm256_cvtpd_ps(a))
#define vec_dbl_tofloat_hi(a, b) _mm256_insertf128_ps(a, _mm256_cvtpd_ps(b), 1)
...
#define vec_dbl_tofloat_lo(a) _mm_cvtpd_ps(a)
#define vec_dbl_tofloat_hi(a, b) _mm_movelh_ps(a, _mm_cvtpd_ps(b))
